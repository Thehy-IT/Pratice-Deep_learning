# Thực hành Deep Learning (Practice-Deep_learning)
...
- Áp dụng các kiến thức đã học vào các bài toán thực tế.
- Xây dựng các mô hình Deep Learning từ cơ bản đến nâng cao.
...
Mọi ý kiến đóng góp, báo lỗi hoặc cải tiến đều được chào đón. Vui lòng tạo một `Issue` hoặc `Pull Request`.
